...
namespace Aurora
{
    ...
    public static class Constant
    {
        ...
        public static class String
        {
            ...
            /// <summary>
            /// 为通过 <see langword="default"/> 运算符或 <see langword="default"/> 文本创建的实例提供 <see cref="object.ToString"/> 的返回值。
            /// </summary>
            public const string DefaultConstructedObjectToString = "default";
        }
